...
const Navbar = () => {
    ...
    const cart = useSelector(store => store.product.cart)   // ✅ FIX
    ...
    // Desktop → Original Navbar (unchanged)
    // Mobile/Tablet → MobileNavbar (new component)
    ...
    // ===== END RESPONSIVE CONDITIONAL RENDERING =====
            ...
            <div className="max-w-7xl mx-auto flex justify-between items-center py-3">
                ...
                <nav className="flex gap-10 justify-between items-center">
                    ...
                    <Link to="/cart" className="relative">
                        <ShoppingCart />
                        <span className="bg-pink-500 rounded-full absolute text-white -top-2 -right-1 px-2 text-sm">
                            {cart?.items?.length || 0}
                        </span>
                    </Link>
