...
const AddressForm = () => {
    ...
    const handlePayment = async () => {
        ...
        try {
            ...
            const options = {
                ...
                theme: { color: "#F472FB" } // ✅ valid hex color
    ...
    return (
        <div className='max-w-7xl mx-auto grid place-items-center p-4 md:p-10'> {/* MODIFIED ADDRESS PAGE - Responsive padding */}
            <div className='pt-10 grid grid-cols-1 md:grid-cols-2 items-start gap-6 md:gap-20 mt-10 max-w-7xl mx-auto w-full'> {/* MODIFIED ADDRESS PAGE - Stack on mobile, grid on desktop */}
                                ...
                                <h2 className='text-lg font-semibold'>Saved Addresses</h2>
                                {
                                    addresses.map((addr, index) => {
                                        return <div
                                            ...
                                            className={`border p-4 rounded-md cursor-pointer relative pr-16 ${selectedAddress === index ? // MODIFIED ADDRESS PAGE - Added pr-16 for delete button space
                ...
                <div>
                    <Card className="w-full md:w-[400px]"> {/* MODIFIED ADDRESS PAGE - Responsive width */}
                        <CardHeader>
