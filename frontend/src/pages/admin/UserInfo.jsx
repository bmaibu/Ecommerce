        ...
        <div className='flex flex-col justify-center items-center min-h-screen bg-gray-100'>
          ...
          <div className='w-full flex gap-10 justify-between items-start px-7 max-w-2xl'>
            ...
            <div className='flex flex-col items-center'>
              <img src={updateUser?.profilePic || userLogo} alt="profile" className='w-32 h-32 rounded-full object-cover' />
            ...
            <form onSubmit={handleSubmit} className='space-y-4 shadow-lg p-5 rounded-lg bg-white w-full'>
              ...
              <Button type='submit' className='w-full mt-4 bg-pink-600 hover:bg-pink-700 text-white font-semibold'>
                Update Profile
              </Button>
